export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'octugen',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Octugen',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'octugen.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://octugen.com',
